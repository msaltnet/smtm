...
class ControllerExportTests(unittest.TestCase):
    def test_cli_controller_is_gone(self):
        ...
        # Intentionally construct the removed API name while keeping active-reference
        # scans clean as we test the public API.
        legacy_controller_name = "J" "pt" "Controller"
