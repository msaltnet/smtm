...
class UpbitTraderIntegrationTester(unittest.TestCase):
    ...
    def setUp(self):
        self.test_list = [
            {
                "preparation": "현재 계좌 정보를 조회합니다.",
                "action": self.query_account,
                "verification": "실제 계좌 정보와 일치하는지 확인하세요.",
            },
            {
                "preparation": "시장가격으로 총액 10,000원 만큼 BTC를 매수합니다.",
            ...
            {
                "preparation": "시장가격으로 0.00014864 만큼 BTC를 매도합니다.",
