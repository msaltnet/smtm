...
class DateConverterTests(unittest.TestCase):
    ...
    def test_to_end_min_return_correct_tuple_list(self):
        ...
        self.assertEqual(result[0], ("2020-02-20T12:00:15", "2020-02-20T17:00:15", 300))
        self.assertEqual(result[1], ("2020-02-20T17:00:15", "2020-02-20T22:00:15", 300))
        self.assertEqual(result[2], ("2020-02-20T22:00:15", "2020-02-20T23:55:10", 115))
