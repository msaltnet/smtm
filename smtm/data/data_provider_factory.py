...
from .simulation_dual_data_provider import SimulationDualDataProvider
from .upbit_binance_data_provider import UpbitBinanceDataProvider

class DataProviderFactory:
    """DataProvider 정보 조회 및 생성을 담당하는 Factory 클래스"""

    DataProvider_LIST = [BinanceDataProvider, UpbitDataProvider, BithumbDataProvider, SimulationDataProvider, SimulationDualDataProvider, UpbitBinanceDataProvider]
